      ...
      <div className="App">
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/epaggelmatias_aggelies/user_profile" element={<Epag_network_profile />} />
            ...
            <Route path="/epaggelmatias_notifications/user_profile" element={<Epag_network_profile />} />
            <Route path="/epaggelmatias_notifications/epaggelmatias_article/:id" element={<Epag_article />} />
