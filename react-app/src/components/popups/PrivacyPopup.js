    ...
    return (<div className="privacy-modal">
        <div className="privacy-modal-content">
            ...
            <div className="privacy-row">
                ...
                <input type="radio" name="privacy" onChange={handlePrivacyChange} checked={selectedPrivacy === false} value={false} className="privacy-row-radio" />
            </div>
            ...
            <div className="privacy-row2">
                ...
                <div className="privacy-row-text">
                    ...
                    <span className="privacy-text-subtitle">Ορατό μόνο σε εσάς και στις συνδέσεις σας</span>
                </div>
                <input type="radio" name="privacy" onChange={handlePrivacyChange} checked={selectedPrivacy === true}  value={true} className="privacy-row-radio" />
            </div>
