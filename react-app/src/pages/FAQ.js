        ...
        <div className="article-text">
            ...
            <div className="toggle-buttons">
                <button className={`toggle-button ${isClicked1 ? 'clicked' : ''}`}
                    onClick={toggleButtonColor1}>Τι είδους θέσεις εργασίας μπορώ να βρω στο CareerHive;</button>
                {isVisible1 && 
                    <div className="frame">
                ...
                <button className={`toggle-button ${isClicked2 ? 'clicked' : ''}`}
                    onClick={toggleButtonColor2}>Πόσο συχνά προστίθενται νέες λίστες θέσεων εργασίας στις αγγελίες;</button>
                {isVisible2 && 
                    <div className="frame">
                        <p>Ενημερώνουμε τις αγγελίες εργασίας μας καθημερινά, γι' αυτό να επισκέπτεστε συχνά την σελίδα των αγγελιών για να βλέπετε τις νέες θέσεις εργασίας όταν αυτές δημοσιεύονται.</p>
                    </div>}
                <br></br>
                <button className={`toggle-button ${isClicked3 ? 'clicked' : ''}`}
                    onClick={toggleButtonColor3}>Ποιες είναι οι αποτελεσματικές στρατηγικές για αναζήτηση εργασίας στελεχών;</button>
                {isVisible3 && 
                <div className="frame">
                    ...
                    <li><b>Εκτελεστικό βιογραφικό και συνοδευτική επιστολή:</b> Προσαρμόστε το εκτελεστικό βιογραφικό σας και τη συνοδευτική επιστολή σας σε κάθε αίτηση, δίνοντας έμφαση στα ηγετικά σας επιτεύγματα, τις στρατηγικές συνεισφορές σας και πώς μπορείτε να αντιμετωπίσετε τις συγκεκριμένες ανάγκες του μελλοντικού οργανισμού.</li>
                </div>}
            </div>
        </div>
      </div>
